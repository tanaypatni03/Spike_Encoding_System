...
################################################################
# This is a generated script based on design: Encoding_System
#
...
# source Encoding_System_script.tcl
...
set design_name Encoding_System
...
proc create_root_design { parentCell } {
  ...
  # Create instance: RateEncoder_0, and set properties
  set RateEncoder_0 [ create_bd_cell -type ip -vlnv xilinx.com:user:RateEncoder:1.0 RateEncoder_0 ]
  ...
  connect_bd_intf_net -intf_net RateEncoder_0_m_axis [get_bd_intf_pins RateEncoder_0/m_axis] [get_bd_intf_pins axi_dma_0/S_AXIS_S2MM]
  connect_bd_intf_net -intf_net axi_dma_0_M_AXIS_MM2S [get_bd_intf_pins RateEncoder_0/s_axis] [get_bd_intf_pins axi_dma_0/M_AXIS_MM2S]
...
HDL_ATTRIBUTE.DEBUG {true} \
  ...
  connect_bd_net -net RateEncoder_0_intr [get_bd_pins RateEncoder_0/intr] [get_bd_pins processing_system7_0/IRQ_F2P] [get_bd_pins system_ila_0/probe0]
  set_property -dict [ list \
HDL_ATTRIBUTE.DEBUG {true} \
 ] [get_bd_nets RateEncoder_0_intr]
  connect_bd_net -net processing_system7_0_FCLK_CLK0 [get_bd_pins RateEncoder_0/clock] [get_bd_pins axi_dma_0/m_axi_mm2s_aclk] [get_bd_pins axi_dma_0/m_axi_s2mm_aclk] [get_bd_pins axi_dma_0/s_axi_lite_aclk] [get_bd_pins axi_smc/aclk] [get_bd_pins processing_system7_0/FCLK_CLK0] [get_bd_pins processing_system7_0/M_AXI_GP0_ACLK] [get_bd_pins processing_system7_0/S_AXI_ACP_ACLK] [get_bd_pins ps7_0_axi_periph/ACLK] [get_bd_pins ps7_0_axi_periph/M00_ACLK] [get_bd_pins ps7_0_axi_periph/S00_ACLK] [get_bd_pins rst_ps7_0_100M/slowest_sync_clk] [get_bd_pins system_ila_0/clk]
  connect_bd_net -net processing_system7_0_FCLK_RESET0_N [get_bd_pins processing_system7_0/FCLK_RESET0_N] [get_bd_pins rst_ps7_0_100M/ext_reset_in]
  connect_bd_net -net rst_ps7_0_100M_interconnect_aresetn [get_bd_pins ps7_0_axi_periph/ARESETN] [get_bd_pins rst_ps7_0_100M/interconnect_aresetn]
  connect_bd_net -net rst_ps7_0_100M_peripheral_aresetn [get_bd_pins RateEncoder_0/reset_n] [get_bd_pins axi_dma_0/axi_resetn] [get_bd_pins axi_smc/aresetn] [get_bd_pins ps7_0_axi_periph/M00_ARESETN] [get_bd_pins ps7_0_axi_periph/S00_ARESETN] [get_bd_pins rst_ps7_0_100M/peripheral_aresetn] [get_bd_pins system_ila_0/resetn]
  connect_bd_net -net spikes [get_bd_pins RateEncoder_0/spikes] [get_bd_pins system_ila_0/probe1]
  set_property -dict [ list \
HDL_ATTRIBUTE.DEBUG {true} \
 ] [get_bd_nets spikes]
