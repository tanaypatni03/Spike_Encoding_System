...
proc create_root_design { parentCell } {
  ...
  connect_bd_net -net RateEncoder_0_intr [get_bd_pins RateEncoder_0/intr] [get_bd_pins processing_system7_0/IRQ_F2P]
  ...
  connect_bd_net -net rst_ps7_0_100M_peripheral_aresetn [get_bd_pins RateEncoder_0/reset_n] [get_bd_pins axi_dma_0/axi_resetn] [get_bd_pins axi_smc/aresetn] [get_bd_pins ps7_0_axi_periph/M00_ARESETN] [get_bd_pins ps7_0_axi_periph/S00_ARESETN] [get_bd_pins rst_ps7_0_100M/peripheral_aresetn]
